...
/obj/item/stack/medical/proc/check_limb_state(var/mob/user, var/obj/item/organ/external/limb)
	. = FALSE
	if(BP_IS_BIOMECHANICAL(limb))
		to_chat(user, SPAN_WARNING("You cannot use \the [src] to treat a biomechanical limb."))
...
/obj/item/stack/medical/attack(var/mob/living/carbon/M, var/mob/user)
	...
	if (istype(M, /mob/living/carbon/human))
		...
		var/obj/item/organ/external/affecting = radial_medical(H,user) //nullchecked by ..()
...
/obj/item/stack/medical/ointment/attack(var/mob/living/carbon/M, var/mob/user)
	...
	if (istype(M, /mob/living/carbon/human))
		var/mob/living/carbon/human/H = M
		var/obj/item/organ/external/affecting = radial_medical(H,user) //nullchecked by ..() //nullchecked by ..()
