//CREDITS TO TEGU, thank you Egor.
#define NEXT_PAGE_ID "__next__"
#define DEFAULT_CHECK_DELAY 20
//Plane defines, as we dont have a dedicated file.
...
/datum/radial_menu/proc/HideElement(obj/screen/radial/slice/E)
	...
	E.choice = null
	E.next_page = FALSE
	E.cut_overlay("radial_next") //Hopefully gets rid of the annoying icon stacks
...
/datum/radial_menu/proc/element_chosen(choice_id,mob/user)
	...
	to_chat(user, SPAN_MFAUNA("Selected [choice_id]"))
...
/proc/show_radial_menu(mob/user, atom/anchor, list/choices, uniqueid, radius, datum/callback/custom_check, require_near = FALSE)
	...
	to_chat(user, SPAN_MFAUNA("Attempting to return [answer]"))
	return answer
